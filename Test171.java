...
○ java.util.Map 인터페이스는 키(key)를 값(value)에 매핑(mapping)하며
   동일한 키를 등록할 수 없고, 유일해야 하며, 각 키는 한 개의 값만을 매핑해야 한다.
...
○ HashMap<K, V> 클래스
	...
	- Hashtable 클래스와 마찬가지로 Map 인터페이스에서 상속받은 HashMap 클래스의 기능은
	  Hashtable과 동일하지만 Synchronization이 없기 때문에 동시성 문제가 없다면
...
public class Test171
{
	public static void main(String[] args) throws IOException
	{
		...
		// null 관련 처리
		//	아래 데이터 입력 유형에 따라 모든 종류의 데이터 입력이 가능하지만
