...
○ java.lang.Math 클래스
	...
	수학(Mathmatics)과 관련된 유용한 속성과 함수들을 제공하는 클래스로 생성자가 있기는 하지만,
	『private』으로 선언되어 있기 때문에 외부에서 객체(인스턴스)를 생성할 수 없다.
...
public class Test145
{
	public static void main(String[] args)
	{
		...
		// → 0.0 ~ 1.0 사이의 난수 : 0.5526054806772338
		//	  0.0 ~ 1.0 사이의 난수 : 0.38383680403472986
	}
}