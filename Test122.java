...
○ 중첩 클래스
	...
	클래스 내부에서만 사용할 보조 클래스가 필요한 경우 클래스를 중첩하여
	프로그램의 구조를 보다 더 간단하고 알아보기 쉽도록 만들 수 있는데
	이러한 클래스를 중첩 클래스라 한다.
...
○ 중첩 클래스의 종류(4가지)
	...
	1. static 중첩 클래스(중첩 내부 클래스)
		...
		- 중첩 클래스의 객체는 중첩 클래스를 포함하고 있는 외부 클래스 객체와 동등하다.
		- 외부 클래스의 클래스 변수와 클래스 메소드는 바로 접근하여 사용하는 것이 가능하다.
		- 중첩 클래스와 중첩 클래스를 포함하고 있는 외부 클래스의 인스턴스 변수와 메소드는
	...
	2. 내부 클래스(inner class)
		...
		- static 중첩 클래스와 마찬가지로 프로그램 구조를 보다 더 간단하고 알아보기 쉽도록 한 것.
	...
	3. 지역 클래스(local class)
		...
		- 클래스의 메소드 안에서 클래스를 정의하는 것으로 내부 멤버 클래스와 유사한 성격을 가지고 있지만,
		  접근제어지시자는 붙일 수 없다.
