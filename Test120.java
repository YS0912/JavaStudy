...
○ 인터페이스의 구현
	...
	자바 프로그램에서 인터페이스를 구현해 주어야 하는데 이러한 기능을 수행하는 것이
	『implements』예약어이다.
...
public class Test120
{
	...
	{
		// 두 인터페이스를 상속받은 인터페이스를 구현하고 해당 인터페이스 뿐만 아니라,
