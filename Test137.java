...
public class Test137
{
	public static void main(String[] args)
	{
		...
		//	  String 문자열을 대상으로 s 번째에서 e-1 번째까지 추출
		//	  (단, 인덱스는 0부터 시작)
		...
		// → -1
		//	  ▶ 찾고자 하는 문자열이 대상 문자열에 존재할 경우, 그 문자열의 인덱스를 반환하지만
		...
		// ○ 대상 문자열(s)와 비교 문자열 『seoul corea』 중 어떤 문자열이 더 큰가?
		//	  ▷ 문자열에 대한 크기 비교
		//		 ▶ 두 문자열이 같다면	 : 0
		//		 ▶ 두 문자열이 다르다면 : 차이를 확인(사전식 배열)

		System.out.println(s.compareTo("seoul korea"));
		// → 0		▶ 두 문자열(s 와 "seoul korea")이 같다.
		System.out.println(s.compareTo("seoul corea"));
		// → 8
		//			▶ c ~ k 사이의 차이를 반환 (defghijk)


		// ○ 대상 문자열(s) 중 해당 문자열을 찾아서 원하는 형태로 수정

		s = "우리나라 대한민국 대한독립 만세";
		s = s.replaceAll("대한", "자주");
		//	-----------------------------
		//	이것만으로는 s 자체가 수정되지 않는다. 수정하여 그 형태를 반환할 뿐!
