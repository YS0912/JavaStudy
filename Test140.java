...
파싱(parsing)하고자 하는 문자열을 인자로 받아 생성하는데,
	...
	이때 나누는 단위가 되는 문자열을 토큰(token)이라고 한다.
	...
	java.util.regex 패키지를 사용할 것을 권장하고 있다.
...
public class Test140
{
	public static void main(String[] args) throws IOException
	{
		...
		//		  확인 결과만 반환할 뿐,
		//		  실제 내용을 읽어들이지도, 읽어들이는 헤드를 이동시키지도 않는다.

		// -- 『nextToken()』
		//		: 다음 토큰을 얻어온다.
		//		: 다음 토큰을 얻어오며 헤드를 이동시키게 된다.
		//		: 구분자를 바꾸었을 경우 다음 호출에도 바뀐 구분자를 이용하여 토큰을 분리
