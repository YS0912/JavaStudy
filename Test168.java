...
○ HashSet<E> 클래스
	...
	java.util.HashSet<E> 클래스는 Set 인터페이스를 구현하는 클래스로
...
public class Test168
{
	public static void main(String[] args)
	{
		...
		for (String s : dog)
			System.out.print(s + " ");
		System.out.println();
		// → 추가 후 데이터 Set 출력 : 진돗개 포메라니안 시베리안허스키 휘튼테리어 도베르만 치와와 비숑 불독 말티즈


		// 데이터가 추가되는 순서와 상관 없이 목록이 구성되어 있으며,
		// 같은 데이터가 여러 번 반복 추가될 경우
		// 이들 중 하나만 유효한 데이터로 구성되어 씨는 것을 확인할 수 있다.
		// (아무리 추가해도 하나만 추가됨)

		// 또한, 자료구조의 특성 상
		// 중복 데이터를 허용하지 않는다고 해서 중복된 데이터를 추가할 경우
